...
STEPS = {
    ...
    # Configuration du matériau du Landscape SEULE — sans raycast, sans bake,
    # sans toucher au manifeste ni à l'asset map. La fonction existait déjà
    # mais n'était atteignable que noyée dans step3_landscape.run() : elle est
    # ici exposée comme une étape à part entière, relançable à volonté pendant
    # qu'on itère sur le matériau dans Unreal (voir operations.py).
    "landscape_material": step3_landscape.configure_landscape_material,
